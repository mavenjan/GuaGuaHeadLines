package com.nxt.maven.guaguaheadlines.home.ui;
...
import com.nxt.maven.guaguaheadlines.adapter.ChannelAdapter;
...
import com.nxt.maven.guaguaheadlines.home.model.entity.Channel;
...
import static com.nxt.maven.guaguaheadlines.home.model.entity.Channel.TYPE_MY_CHANNEL;
...
public class ChannelDialogFragment extends DialogFragment implements OnChannelDragListener {
    ...
    public static ChannelDialogFragment newInstance(List<Channel> selectedDatas, List<Channel> unselectedDatas) {
        Log.e(TAG, "newInstance:selectedDatas ---------->" + selectedDatas);
        Log.e(TAG, "newInstance:unselectedDatas ---------->" + unselectedDatas);
