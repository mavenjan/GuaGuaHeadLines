...
import com.nxt.maven.guaguaheadlines.adapter.CommentAdapter;
...
import com.nxt.maven.guaguaheadlines.home.model.event.DetailCloseEvent;
...
public abstract class NewsDetailBaseActivity extends MBaseActivity<NewsDetailPresenter> implements NewsDetailView, BaseQuickAdapter.RequestLoadMoreListener {
