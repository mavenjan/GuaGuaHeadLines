...
public final class Response<T> {
    ...
    public static <T> com.lzy.okgo.model.Response<T> success(boolean isFromCache, T body, Call rawCall, okhttp3.Response rawResponse) {
    ...
    public static <T> com.lzy.okgo.model.Response<T> error(boolean isFromCache, Call rawCall, okhttp3.Response rawResponse, Throwable throwable) {
        com.lzy.okgo.model.Response<T> response = new com.lzy.okgo.model.Response<>();
        response.setFromCache(isFromCache);
        response.setRawCall(rawCall);
        response.setRawResponse(rawResponse);
