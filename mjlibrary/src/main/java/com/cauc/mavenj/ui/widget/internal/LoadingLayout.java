 ...
 *******************************************************************************/
package com.cauc.mavenj.ui.widget.internal;
...
import com.cauc.mavenj.ui.widget.pulltorefresh.PullToRefreshBase;
import com.cauc.mavenj.ui.widget.pulltorefresh.ILoadingLayout;
...
public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout {
	...
	public LoadingLayout(Context context, final PullToRefreshBase.Mode mode, final PullToRefreshBase.Orientation scrollDirection, TypedArray attrs) {
		...
		switch (scrollDirection) {
			case HORIZONTAL:
				LayoutInflater.from(contexmt).inflate(R.layout.pull_to_refresh_header_horizontal, this);
				break;
			case VERTICAL:
			default:
